...
class dashboard_featured_ad_declined extends StatefulWidget {
  dashboard_featured_ad_declined({Key key}) : super(key: key);

  @override
  _dashboard_featured_ad_declinedState createState() =>
      _dashboard_featured_ad_declinedState();
}

class _dashboard_featured_ad_declinedState
    extends State<dashboard_featured_ad_declined> {
  bool visibility;
  ...
  Future getapprovalrequest() async {
    ...
    QuerySnapshot qs = await fstore1
        .collection("featured ad response{$emailid} declined")
        .get();
