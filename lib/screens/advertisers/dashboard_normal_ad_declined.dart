...
class dashboard_normal_ad_declined extends StatefulWidget {
  @override
  _dashboard_normal_ad_declinedState createState() =>
      _dashboard_normal_ad_declinedState();
}

class _dashboard_normal_ad_declinedState
    extends State<dashboard_normal_ad_declined> {
  bool visibility;
  ...
  Future getapprovalrequest() async {
    ...
    QuerySnapshot qs =
        await fstore1.collection("normal ad response{$emailid} declined").get();
