...
class dashboard_normal_ad_approved extends StatefulWidget {
  @override
  _dashboard_normal_ad_approvedState createState() =>
      _dashboard_normal_ad_approvedState();
}

class _dashboard_normal_ad_approvedState
    extends State<dashboard_normal_ad_approved> {
  bool visibility;
  int price1, ads;
  int total;
  ...
  Future getapprovalrequest() async {
    ...
    QuerySnapshot qs =
        await fstore1.collection("normal ad response{$emailid} approved").get();
